...
import SidebarProductCarted from '@/components/story/wines/[id]/edit/SidebarProductCarted';
import SidebarProductFav from '@/components/story/wines/[id]/edit/SidebarProductFav';
...
const SidebarProduct = () => {
  const setLocation = useResetRecoilState(locationSelectorState);
  ...
  return (
    ...
    >
      ...
      <div className={cx(`relative`, `w-full h-full px-12 border-b-2`)}>
        <SidebarProductCarted item={activeWine} />
        <SidebarProductFav item={activeWine} />
