...
import ScrollStoryTitleForm from '@/components/wineries/[id]/stories/[storyId]/chapters/[chapterId]/ScrollStoryTitleForm';
...
const ScrollStorySectionTitle = ({chapterId}) => {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {isShow && <ScrollStoryTitleForm setIsShow={setIsShow} />}
      </AnimatePresence>
    </div>
  );
};
