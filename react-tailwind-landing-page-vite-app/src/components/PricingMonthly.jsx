...
const PricingMonthly = () => {
  return (
    ...
    >
      <h2 className="text-3xl pb-1">Monthly Pricing</h2>
      <div
        className={cx(
          css`
      ...
      >
        <div className="border-2 p-2">
          <h3 className="text-3xl flex justify-center items-center pt-4 pb-4">
            Basic
          </h3>
          <div
            className={cx(
          ...
          >
            <div className="text-4xl flex justify-center items-center border-t-2 pt-2 pb-2">{`$${49}`}</div>
            <div
              className={cx(
                css``,
        ...
        <div className="border-2 p-2">
          ...
          >
            <div className="text-4xl flex justify-center items-center border-t-2 pt-2 pb-2">{`$${149}`}</div>
            <div
              className={cx(
                css``,
                `flex justify-center items-center flex-col gap-1`
